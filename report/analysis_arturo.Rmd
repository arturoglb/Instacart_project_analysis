...
For this approach we want to measure the accuracy of the model with the unbalanced data. In addition, it will be interesting to see which departments were considered as the best to split the data into the days of the week to be compared with a balanced data with cross validation (2nd approach). 
